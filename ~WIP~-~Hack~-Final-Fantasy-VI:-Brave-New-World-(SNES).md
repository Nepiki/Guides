# 1. Table of Contents<a name="top"></a>
* [Overview](#overview)
...
We are not trying to play optimally and minmax. We are trying to 100% this very fair set on this very difficult game with as little difficulty as possible. Do as you will.
[Top](#top)
...
The Evil That Men Do - Witness Kefka poison Doma, meet Cyan, then pass through the imperial encampment. Unlocks once you leave the Imperial encampment with Cyan in the party.
...
No Machine Can Stump Me - Check in on Cid and Setzer and hear a bit on Setzer's past. After the banquet, walk all the way southewest to Miranda and enter your airship. Head to the engine room and witness a scene between Cid and Setzer. Unlocks after that scene.
...
Treasure Hunter II - Hunt down all the treasure in the Magitek Factory in Vector. There are 10 chests, with 9 in the big areas before the fight vs. Shiva and Ifrit, and the final one in the tube room before Number 024.
...
The Book of Souls 1 - Obtain 30 different rages for Gau.
...
It's a Mystery... - Equip a Mystery Egg to Celes. Take Locke to the Phantom Forest and encounter a Wight, the ghost enemy. This is a rare steal. It is also found on Wraith (cave to the sealed gate) or Revenant (Phoenix Cave). Unlocks when Celes has it equipped.
...
Biggs' Briefing - Defeat the Whelk in the Narshe cavern.
...
Kaiser Dragon - Slay the Kaiser, greatest of all dragons (Max level 33).
...
Your priority is keeping Terra alive who will consistently do near max damage against Tritoch's 50,000 HP. Likely, the Figaro brothers WILL die, but by the time they are both dead, Tritoch is nearly dead as you only need 5 full rounds at most to end this.
[Top](#top)
### <a name="yeti"></a>Yeti
| Name | Right Hand | Left Hand | Head | Body | Relic | Relic | Esper |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
Float before battle! There are several phases to this fight. The first two phases are Guardian's Ultros form and your buffing phase.
...
Float before the battle. Terra is going to Morph and then spam Fire3 and absolutely nothing else while everyone else is here to make sure she stays alive and has MP to spam Fire3. The only concern here is when Asura uses Loc Nar which will one-shot Terra, so be ready. Fire3 is also more economical than Ultima (damage vs. MP cost), so we won't use Ultima. Terra may take one break, however, if some people are frozen and she's not; have her throw a Fire on the team--everyone will withstand it no problem.
...
Other than being frozen, Asura is the easiest of the trio.
[Top](#top)
### <a name="isis"></a>Isis (Right)
| Name | Right Hand | Left Hand | Head | Body | Relic | Relic | Esper |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Gau | Magic Bone | Thunderguard | Skull Cap | Dragon Hide | Sprint Shoes | Life Bell | Fenrir |
| Mog | Longinus | None | Dragon Helm | Force Armor | Dragoon Seal | Power Glove | Palidor |
| Strago | Doomstick | Multiguard | Circlet | Dragon Hide | Sage Stone | Magic Cube | Carbunkl |
| Relm | Dali Brush | Thunderguard | Cat Hood | Lazy Shell | Magic Cube | Life Bell | Zoneseek |

A difficult enemy with our leftover party members. And yet, this will prove to be a very easy fight, although it will be a very long one.  A note:  should anyone die without Rerise, you need to wait for two others to have full ATB so you can either Phoenix Down + Relm's Cure3 or Phoenix Down + Potion to get that person back up.  This will happen a few times because of the Charm status Isis will inflict on others where you need to kill one of your team members to undo it.

At the start, Mog should get Haste on Strago and Relm and Relm needs to use RegenX to get Mog Regen status. If Mog should ever get afflicted with Berserk, you are free to leave him alone as he will not only do more damage, but he'll Jump most of the time. If the whole party has Rerise and Relm gets hit with Berserk, you can leave her be, too, as whoever is in love with Isis is going to get a lot of free healing. However, get her a Green Cherry whenever you need control or if someone doesn't have Rerise. Anyone else with Berserk should be taken out of it immediately.

Now, if someone gets hit with Charm, you either need to act immediately or can put it off for a round or two and not stress out. If Strago or Mog get hit with Charm, they need to die and be brought back to life immediately; Relm and Gau can wait a minute.

Buffs applied, Gau uses Conjurer Rage, Mog uses Jump.  Relm's #1 priority is healing, but go ahead and summon Zoneseek on her first turn.  When things seem safe or you feel confident, have her Sketch Isis and watch Holy tear through Isis.

Strago will double-cast Slow then Dark until Isis has Slow, and from then on will double-cast Dark.  When he runs out of MP, which he will, have him double-cast Osmose. Nobody else should need MP, even with Relm using a lot of Cure3.  Occasionally, have Strago throw a Potion on someone.

A worst case scenario can present itself where Gau is uncontrollable because of Rage, one character has Charm, and the other two have Berserk.  This happened to me several times and is a bit concerning but more amusing as you just patiently wait for someone to die and come back with Rerise so you can act, which is why you must ALWAYS have Rerise on.

Isis will spam Quasar a lot eventually, but this won't one-shot anyone in good health. Her other attacks are nonissues as her bolt based spells will heal the party or be shrugged off by them (except Mog who only mitigates with Force Armor), and Storm does no significant damage.  Just keep up the slow but steady grind and Isis will fall.
[Top](#top)
### <a name="kefka"></a>Kefka (Final)
| Name | Right Hand | Left Hand | Head | Body | Relic | Relic | Esper |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
This setup will also work for the non-Esper-Level run!  However, be prepared for a tougher and more exhausting fight, and Edgar needs over 1,100 HP (he can sacrifice a Dragon Helm for a Stat Hat if necessary).  Just make sure to have no Espers if you are doing the no-Esper-Level run!
...
Good luck!
[Top](#top)
<a name="first"></a>**_Face, Short Arm, Long Arm_**
Do not worry about buffs as they will just be Dispeled. Everyone will do essentially one thing--
Gau: Conjurer Rage
Gogo: Conjurer Rage
Edgar: Jump
Terra: Party-wide Cure3
...
[Top](#top)
<a name="second"></a>*__Hit, Magic, Tiger, Tools__*
...
[Top](#top)
# 5. <a name="walkthrough"></a>Walkthrough
Info
[Top](#top)
### <a name="start"></a>Start to Zozo; Pre-Esper
Info

Pre-Zozo:  Albatross, Antlion, Bomb, Conjurer, Crawler, Exocite, Eye Goo, Hornet, Leafer, Lich, Raven, Repo Man, Scrapper, Sewer Rat, Soldier, Spirit, Stray Cat, Tek Armor, Vaporite


Goggles are replaced by Talisman; Bracelet still valuable for Magic/Magic Defense points.  Increased likelihood of back attacks or being surrounded starting around Jidoor; get a Back Guard.
[Top](#top)
### <a name="wob"></a>Zozo to Floating Continent

Chickenlip, Doggo, Rain Man Rages outside of Magitek Research Facility. Onion Kid (upper levels; need Onion Kid x5) and Rhydon and Vulture (lower levels), Flan and Templar (area with tubes; need Templar and 2x Flan for Templar's).

After you get airship, go to near Thamasa for Cephalid, Adamantite, and Chimera Rages (be careful with Chimeras as they are very dangerous).

Miss some Rages from Magitek Research Facility and/or Phantom Train?  Phantom Train's monsters are found in forest west of Veldt (where Bombs/Grenades used to be), and Magitek Research Facility's monsters are found on Triangle Island in northeast corner of map. You will also run into Sealed Gate monsters here.

Good GP grinding party:  Setzer, Gau, Edgar, Cyan, with whatever you consider best equipment. Take them around Jidoor and have Cyan use Dispatch, Gau use Albatross, Edgar use Autocrossbow, and Setzer use Slots. Hold fast forward, hold A, and profit! Setzer's failed Slots will keep people alive, and you may occasionally lose Cyan, but you can just rest at Jidoor.  You get a few thousand GP every few seconds with minimal effort on your part.  Use this to pick up some Sprint Shoes, new weapons/armor from Narshe, a bunch of Potions/Tonics/Tinctures/Red Bulls/Dry Meats/Remedies, and the two Espers from the man in the northwest corner of the map who later builds the Dragon Gate Coliseum.

Go directly east of the Dragon Gate Coliseum man's house to an area that touches the topmost almost-center of the map, northeast of Narshe. There is some grass around mountains. Land here, run into a Cactuar (Edge's Drill will one-shot it), and get an achievement.

Spirit Stone replaces Talisman.  Bracelet still viable for Magic/Magic Defense points.
...
Three Commandos and one Mega Armor at Magitek Facility when talking to 24 soldiers. The Commandos die easily.  A Pummel from Sabin or Rain Man Rage from Gau or any Bolt or high level spell from anyone else will make short work of the Heavy Armor.
Feel free to unequip everyone except Terra and/or Locke before time runs out.
Banquet:  "To our fallen comrades," "Leave him in jail," "That, we can't forgive," "We trust Celes," ask each question exactly once before talking about Espers, "Yes, they are a danger," first question you picked, take a break and go fight the three Templars, resume banquet, "That your war is truly over," choose Yes.
