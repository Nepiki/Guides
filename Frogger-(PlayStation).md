...
* [Tips & Tricks](https://github.com/RetroAchievements/guides/wiki/Frogger-(PlayStation)/#conclusion---tips--tricks) 
...
Here you can give a detailed explanation about every step, such as 
...
To make this header link to the section with these achievements, go 
...
Remove everything of the link before "step".

You can create as many steps as you desire. Recommended is to have 
one step dedicated to unmissable story achievements, while the others 
cover game-specific steps (like no-damage bosses, item collection etc.)
...
Dummy section that can be used for any other comments not already 
...
<details> 
<summary>Map</summary> 
<img src="https://i.imgur.com/odjv8Wb.png"> 
</details> 
